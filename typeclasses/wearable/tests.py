...
class EquipmentCommandTests(TestEquipmentMixins, ArxCommandTest):
    def test_wield_cmd(self):
        ...
        self.call_cmd(
            "lickyknife1", "Equipment changes are only allowed in combat's setup phase."
        )
        fight.ndb.phase = 1
        self.call_cmd("lickyknife1", "You brandish Lickyknife1.")
        self.room1.msg_contents.assert_called_with(
            "Char2 wields Lickyknife1.", exclude=[self.char2]
        )
        self.assertTrue(self.knife1.is_wielded)
        self.assertEqual(self.char2.combat.attack_skill, "small wpn")
        self.call_cmd(
            "lickyknife1", "Could not brandish Lickyknife1 (already wielded)."
        )
        self.hairpins1.wear(self.char2)
        self.call_cmd(
            "hairpins1", "Could not brandish Hairpins1 (other weapon in use)."
        )
        ...
        self.room1.msg_contents.assert_called_with(
            "Char2 wields Hairpins1.", exclude=[self.char2]
        )
    ...
    def test_wear_cmd(self):
        ...
        # to prevent ties
        self.catsuit1.craft_handler.worn_time += 1
        ...
        self.mask1.craft_handler.worn_time += 10
        ...
        self.call_cmd(
            "lickyknife1",
            "Could not remove Lickyknife1 (not equipped).",
            cmdstring="remove",
        )
        outfit2 = self.create_ze_outfit(
            "Friendly Shadows"
        )  # top1, slinkity1, hairpins1; sheathed sword1
        ...
        self.call_cmd(
            "/outfit unfriendly",
            "'unfriendly' not found in your collection of outfits.",
        )
        self.call_cmd(
            "/outfit friendly",
            "'friendly' refers to more than one outfit; please be more specific.",
        )
        ...
        self.call_cmd(
            "/outfit friendly shadows",
            "Could not remove Slinkity1 (not equipped).\nYou remove Sword1, "
            "Top1, and Hairpins1.",
            cmdstring="remove",
        )
        ...
        self.call_cmd(
            "/outfit friendly shadows",
            "Could not remove Sword1 (not equipped), Top1 (not equipped), "
