    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed', models.ManyToManyField(blank=True, related_name='allowed_flashbacks', to='character.RosterEntry')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_flashbacks', to='character.RosterEntry')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('read_by', models.ManyToManyField(blank=True, related_name='read_flashback_posts', to='character.RosterEntry')),
            ],
            options={
                'abstract': False,
            },
