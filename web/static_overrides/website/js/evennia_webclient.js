...
// Display messages
// scrolling up with mousewheel now locks the screen
var locked = false;
...
function msg_display(type, msg){
	...
	var $msgwin = $('#messagewindow');
	var offset = $msgwin[0].scrollHeight - $msgwin.scrollTop();
    $("#messagewindow").append(
        "<div class='msg "+ type +"'>"+ msg +"</div>");
    // scroll message window to bottom
	if (locked) {
		$('#messagewindow').animate({scrollTop: $('#messagewindow')[0].scrollHeight - offset}, 20);
	}
	else {
		$('#messagewindow').animate({scrollTop: $('#messagewindow')[0].scrollHeight}, 20);
	}
