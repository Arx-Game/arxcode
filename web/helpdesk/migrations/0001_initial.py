    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        upload_to=web.helpdesk.models.attachment_path,
                        max_length=1000,
                        verbose_name="File",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(
                        help_text="Date on which escalation should not happen",
                        verbose_name="Date",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        max_length=200, null=True, verbose_name="Title", blank=True
                    ),
                ),
                (
                    "comment",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateField(
                        help_text="Date on which this e-mail address was added",
                        verbose_name="Date",
                        editable=False,
                        blank=True,
                    ),
                ...
                (
                    "email_address",
                    models.CharField(
                        help_text="Enter a full e-mail address, or portions with wildcards, eg *@domain.com or postmaster@*.",
                        max_length=150,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "body",
                    models.TextField(
                        help_text="Context available: {{ ticket }} - ticket object (eg {{ ticket.title }}); {{ queue }} - The queue; and {{ user }} - the current user.",
                        verbose_name="Body",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "locale",
                    models.CharField(
                        help_text="Locale of this queue. All correspondence in this queue will be in this language.",
                        max_length=10,
                        null=True,
                        verbose_name="Locale",
                        blank=True,
                ...
                (
                    "new_ticket_cc",
                    models.CharField(
                        help_text="If an e-mail address is entered here, then it will receive notification of all new tickets created for this queue. Enter a comma between multiple e-mail addresses.",
                        max_length=200,
                        null=True,
                ...
                (
                    "updated_ticket_cc",
                    models.CharField(
                        help_text="If an e-mail address is entered here, then it will receive notification of all activity (new tickets, closed tickets, updates, reassignments, etc) for this queue. Separate multiple addresses with a comma.",
                        max_length=200,
                        null=True,
                ...
                (
                    "email_box_type",
                    models.CharField(
                        choices=[("pop3", "POP 3"), ("imap", "IMAP")],
                        max_length=5,
                        blank=True,
                        help_text="E-Mail server type for creating tickets automatically from a mailbox - both POP3 and IMAP are supported.",
                        null=True,
                ...
                (
                    "email_box_host",
                    models.CharField(
                        help_text='Your e-mail server address - either the domain name or IP address. May be "localhost".',
                        max_length=200,
                        null=True,
                ...
                (
                    "email_box_port",
                    models.IntegerField(
                        help_text='Port number to use for accessing e-mail. Default for POP3 is "110", and for IMAP is "143". This may differ on some servers. Leave it blank to use the defaults.',
                        null=True,
                ...
                (
                    "email_box_pass",
                    models.CharField(
                        help_text="Password for the above username",
                        max_length=200,
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        help_text="If using IMAP, what folder do you wish to fetch messages from? This allows you to use one IMAP account for multiple queues, by filtering messages on your IMAP server into separate folders. Default: INBOX.",
                        max_length=100,
                        null=True,
                ...
                (
                    ...
                    models.IntegerField(
                        default="5",
                        help_text="How often do you wish to check this mailbox? (in Minutes)",
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "due_date",
                    models.DateTimeField(null=True, verbose_name="Due on", blank=True),
                ),
                (
                    "last_escalation",
                    models.DateTimeField(
                        help_text="The date this ticket was last escalated - updated automatically by management/commands/escalate_tickets.py.",
                        null=True,
                        editable=False,
                        blank=True,
                    ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        to=settings.AUTH_USER_MODEL,
                        help_text="User who wishes to receive updates for this ticket.",
                        null=True,
                        verbose_name="User",
                        on_delete=models.CASCADE,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "old_value",
                    models.TextField(null=True, verbose_name="Old Value", blank=True),
                ),
                (
                    "new_value",
                    models.TextField(null=True, verbose_name="New Value", blank=True),
                ),
                (
                    "followup",
                    models.ForeignKey(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        verbose_name="Depends On Ticket",
                        to="helpdesk.Ticket",
                        on_delete=models.CASCADE,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        ...
                        null=True,
                        verbose_name="Settings Dictionary",
                        blank=True,
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                verbose_name="Ticket", to="helpdesk.Ticket", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AddField(
