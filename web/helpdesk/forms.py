...
class PublicTicketForm(CustomFieldMixin, forms.Form):
    ...
    body = forms.CharField(
        ...
        required=True,
        help_text=_(
            "Please be as descriptive as possible, including any "
...
class UserSettingsForm(forms.Form):
    ...
    email_on_ticket_apichange = forms.BooleanField(
        ...
        help_text=_(
            "If a ticket is altered by the API, do you want to receive an e-mail?"
        ),
        required=False,
    )
    ...
    use_email_as_submitter = forms.BooleanField(
        ...
        help_text=_(
            "When you submit a ticket, do you want to automatically use your e-mail address as the submitter address? You can type a different e-mail address when entering the ticket if needed, this option only changes the default."
        ),
        required=False,
    )
