    ...
    def forwards(self, orm):
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "priority",
                    self.gf("django.db.models.fields.IntegerField")(default=3, blank=3),
                ),
                (
                    "last_escalation",
                    self.gf("django.db.models.fields.DateTimeField")(
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "date",
                    self.gf("django.db.models.fields.DateTimeField")(
                        default=datetime.datetime(2011, 4, 27, 15, 17, 4, 272904)
                    ),
                ),
                (
                    "title",
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "presetreply",
                    models.ForeignKey(orm["helpdesk.presetreply"], null=False),
                ),
        ...
        db.create_table(
            "helpdesk_escalationexclusion_queues",
            (
                (
                    "id",
                    models.AutoField(
                ...
                (
                    "escalationexclusion",
                    models.ForeignKey(orm["helpdesk.escalationexclusion"], null=False),
                ),
                ("queue", models.ForeignKey(orm["helpdesk.queue"], null=False)),
            ),
        )
        db.create_unique(
            "helpdesk_escalationexclusion_queues",
            ["escalationexclusion_id", "queue_id"],
        )

        # Adding model 'EmailTemplate'
        db.create_table(
            "helpdesk_emailtemplate",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "template_name",
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "ignoreemail",
                    models.ForeignKey(orm["helpdesk.ignoreemail"], null=False),
                ),
                ("queue", models.ForeignKey(orm["helpdesk.queue"], null=False)),
            ),
        )
        ...
        db.create_table(
            "helpdesk_ticketcustomfieldvalue",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "ticket",
    ...
    models = {
        ...
        "helpdesk.ticketcustomfieldvalue": {
            "Meta": {
                ...
                "object_name": "TicketCustomFieldValue",
            },
            "field": (
                "django.db.models.fields.related.ForeignKey",
                [],
