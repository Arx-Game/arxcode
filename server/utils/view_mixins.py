...
class LimitPageMixin(object):
    ...
    def get_context_data(self, **kwargs):
        ...
        for page_name in self.additional_pages:
            ...
            context = adjust_pagination(context, page, begin_pages=self.begin_pages,
                                        end_pages=self.end_pages, before_current_pages=self.before_current_pages,
                                        after_current_pages=self.after_current_pages, page_name=page_name)
        return context