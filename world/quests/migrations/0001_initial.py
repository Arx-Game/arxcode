# Generated by Django 2.2.9 on 2020-06-16 15:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quest', models.ForeignKey(blank=True, help_text="Character's status/progress on another quest, not the quest itself.", null=True, on_delete=django.db.models.deletion.CASCADE, related_name='used_in_efforts', to='quests.QuestStatus', verbose_name='Required Quest')),
