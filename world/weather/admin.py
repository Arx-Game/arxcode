...
class WeatherEmitInline(admin.StackedInline):
    ...
    fieldsets = [
        ...
        (
            "Details",
            {
                "fields": [("intensity_min", "intensity_max", "weight", "gm_notes")],
                "classes": ["collapse"],
            },
        ),
        (
            "Seasons",
            {
                "fields": [("in_summer", "in_fall", "in_winter", "in_spring")],
                "classes": ["collapse"],
            },
        ),
        (
            "Times",
            {
                "fields": [("at_morning", "at_afternoon", "at_evening", "at_night")],
                "classes": ["collapse"],
            },
        ),
    ]
...
class WeatherTypeAdmin(admin.ModelAdmin):
    model = WeatherType
    list_display = ("id", "name", "gm_notes", "automated", "emit_count", "total_weight")
    ordering = ("id",)
    extra = 0
