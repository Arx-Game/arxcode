...
class TestPetitionCommands(ArxCommandTest):
    def test_cmd_broker(self):
        ...
        self.call_cmd(
            "/buy ap=1,-5", "You must provide a positive number as the price."
        )
        self.call_cmd(
            "/buy ap=-1,5", "You must provide a positive number as the amount."
        )
        ...
        sale2 = BrokeredSale.objects.create(
            owner=self.dompc2, sale_type=BrokeredSale.ECONOMIC, amount=50, price=5
        )
        ...
        self.call_cmd(
            "/sell ap=10,-20", "You must provide a positive number as the price."
        )
        self.call_cmd(
            "/sell ap=10,100",
        ...
        self.call_cmd(
            "/sell ap=600,500", "You do not have enough action points to put on sale."
        )
        self.call_cmd(
        ...
        self.call_cmd(
            "/sell asdf=2,500", "Could not find a material by the name 'asdf'."
        )
        self.call_cmd(
            "/sell testium=1,500",
        ...
        self.call_cmd(
            "/reprice 6=200", "You can only change the price of your own sales."
        )
        self.call_cmd(
            "/reprice 14=-50", "You must provide a positive number as the price."
        )
        self.call_cmd(
            "/reprice 14=50", "The new price must be different from the current price."
        )
        self.call_cmd(
            "/reprice 14=500",
        ...
        self.call_cmd(
            "/sell social=5,250",
            "You have sold 5 Social Resources to Testaccount2 for 1500 silver.",
        )
        self.call_cmd(
            "/sell social=55,350",
        ...
        self.call_cmd(
            "/reprice 17=300",
            "You have sold 45 Social Resources to Testaccount2 for 13500 silver.|"
    ...
    def test_cmd_petition(self):
        ...
        self.call_cmd(
            "test org", "You do not have access to view petitions for test org."
        )
        self.call_cmd(
            "/assign 1=testaccount", "You are not allowed to access that petition."
        )
        ...
        self.call_cmd(
            "",
            "Updated   ID Owner        Topic Org      On \nU"
            + date.today().strftime("%m/%d/%y")
            + " 1  Testaccount2 test  test org",
        )
        self.call_cmd(
            "/assign 1=testaccount2",
            "You can only assign members of your organization.",
        )
        self.call_cmd(
            "/assign 1=testaccount", "You have assigned Testaccount to the petition."
        )
        self.call_cmd("/assign 1=testaccount", "You have already signed up for this.")
        self.call_cmd(
            "/remove 1=testaccount2",
            "You can only remove members of your organization.",
        )
        self.call_cmd(
            "/remove 1=testaccount", "You have removed Testaccount from the petition."
        )
        self.call_cmd(
            "/remove 1=testaccount", "You are not signed up for that petition."
        )
        ...
        self.call_cmd(
            "/org", "Petition Being Created:\nTopic: None\nDescription: None\n"
        )
        self.call_cmd(
            "/topic test", "Petition Being Created:\nTopic: test\nDescription: None\n"
        )
        self.call_cmd(
            "/desc testing",
            "Petition Being Created:\nTopic: test\nDescription: testing\n",
        ...
        self.account2.inform = Mock()
        self.call_cmd(
            "/ignore general", "You are no longer informed of new general petitions."
        )
        ...
        self.account2.inform = Mock()
        self.call_cmd(
            "/ignore general", "You are now informed of new general petitions."
        )
        ...
        self.caller = self.char1
        self.call_cmd(
            "/ignore test org", "You are no longer informed of new test org petitions."
        )

        self.caller = self.char2
        self.account1.inform = Mock()
        self.char2.db.petition_form = {
            "topic": "test2",
            "description": "testing2",
            "organization": org.id,
        }
        ...
        self.caller = self.char1
        self.call_cmd(
            "/ignore test org", "You are now informed of new test org petitions."
        )
