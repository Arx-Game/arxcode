    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                help_text=b"Should succeeding on this roll make the obstacle open to everyone else?",
                verbose_name=b"Override on Success",
            ),
        ),
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[
                    ...
                    (1, b"Possess Any Associated Clue"),
                    (2, b"Possess All Associated Clues"),
                ]
            ),
        ),
        migrations.AddField(
