...
class Shardhaven(SharedMemoryModel):
    ...
    location = models.ForeignKey('dominion.MapLocation', related_name='shardhavens', blank=True, null=True, on_delete=models.CASCADE)
    haven_type = models.ForeignKey('ShardhavenType', related_name='havens', blank=False, null=False, on_delete=models.CASCADE)
...
class ShardhavenDiscovery(SharedMemoryModel):
    ...
    player = models.ForeignKey('dominion.PlayerOrNpc', related_name='shardhaven_discoveries', on_delete=models.CASCADE)
...
class ShardhavenObstacleRoll(SharedMemoryModel):
    ...
    obstacle = models.ForeignKey(ShardhavenObstacle, related_name='rolls', blank=True, null=True, on_delete=models.CASCADE)
...
class ShardhavenObstacleClue(SharedMemoryModel):
    ...
    obstacle = models.ForeignKey(ShardhavenObstacle, related_name='clues', blank=False, null=False, on_delete=models.CASCADE)
...
class ShardhavenPuzzle(SharedMemoryModel):
    ...
    obstacle = models.ForeignKey(ShardhavenObstacle, blank=False, null=False, related_name='puzzles', on_delete=models.CASCADE)
...
class ShardhavenPuzzleMaterial(SharedMemoryModel):
    ...
    puzzle = models.ForeignKey(ShardhavenPuzzle, blank=False, null=False, related_name='alchemical_materials', on_delete=models.CASCADE)
    weight = models.SmallIntegerField(default=10, help_text="A weight chance that this puzzle will drop this material.")
    material = models.ForeignKey('magic.AlchemicalMaterial', blank=False, null=False, on_delete=models.CASCADE)
    minimum_quantity = models.PositiveSmallIntegerField(default=1)
...
class ShardhavenPuzzleCraftingMaterial(SharedMemoryModel):
    ...
    puzzle = models.ForeignKey(ShardhavenPuzzle, blank=False, null=False, related_name='crafting_materials', on_delete=models.CASCADE)
    weight = models.SmallIntegerField(default=10, help_text="A weight chance that this puzzle will drop this material.")
    material = models.ForeignKey('dominion.CraftingMaterialType', blank=False, null=False, on_delete=models.CASCADE)
    minimum_quantity = models.PositiveSmallIntegerField(default=1)
    maximum_quantity = models.PositiveSmallIntegerField(default=1)
...
class ShardhavenPuzzleObjectLoot(SharedMemoryModel):
    ...
    puzzle = models.ForeignKey(ShardhavenPuzzle, blank=False, null=False, related_name='object_drops', on_delete=models.CASCADE)
    weight = models.SmallIntegerField(default=10, help_text="A weight chance that this puzzle will drop this object.")
    object = models.ForeignKey('objects.ObjectDB', blank=False, null=False, on_delete=models.CASCADE)
...
class ShardhavenLayoutExit(SharedMemoryModel):
    ...
    layout = models.ForeignKey('ShardhavenLayout', related_name='exits', on_delete=models.CASCADE)

    room_west = models.ForeignKey('ShardhavenLayoutSquare', related_name='exit_east', null=True, blank=True, on_delete=models.CASCADE)
    room_east = models.ForeignKey('ShardhavenLayoutSquare', related_name='exit_west', null=True, blank=True, on_delete=models.CASCADE)
    room_north = models.ForeignKey('ShardhavenLayoutSquare', related_name='exit_south', null=True, blank=True, on_delete=models.CASCADE)
    room_south = models.ForeignKey('ShardhavenLayoutSquare', related_name='exit_north', null=True, blank=True, on_delete=models.CASCADE)

    obstacle = models.ForeignKey(ShardhavenObstacle, related_name='+', null=True, blank=True, on_delete=models.CASCADE)
...
class ShardhavenLayoutSquare(SharedMemoryModel):
    ...
    """
    layout = models.ForeignKey('ShardhavenLayout', related_name='rooms', on_delete=models.CASCADE)
    ...
    tile = models.ForeignKey('dominion.PlotRoom', related_name='+', on_delete=models.CASCADE)

    room = models.OneToOneField('objects.ObjectDB', related_name='shardhaven_room', blank=True, null=True, on_delete=models.CASCADE)
    ...
    puzzle = models.ForeignKey(ShardhavenPuzzle, blank=True, null=True, related_name='+', on_delete=models.CASCADE)
    puzzle_solved = models.BooleanField(default=False)

    monster = models.ForeignKey(Monster, blank=True, null=True, related_name='+', on_delete=models.CASCADE)
...
class ShardhavenLayout(SharedMemoryModel):
    ...
    haven = models.OneToOneField(Shardhaven, related_name='layout', null=True, blank=True, on_delete=models.CASCADE)
